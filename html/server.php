<?php 
    ...
    //echo 'didnt Windows';
    $db = new mysqli("localhost", "jonathangc", "admin","users");
}
	...
	if (isset($_POST['reg_cliuser'])) {
		...
		} header ('location:https://jorgeochoa1987.github.io/videocall_/');
	...
	if (isset($_POST['login_user'])) {
		...
		if (count($errors) == 0) {
			...
			if (mysqli_num_rows($results) == 1) {
				...
				array_push($errors, "Usuario/Contraseña erroneos, trate de nuevo");
			}
		}
	}
