...
<body class="bg-default">
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Sistema de llamadas por ip</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer class="py-5" id="footer-main">
    <center>
      <p> Desarrollado por: Camilo Andrés Florez Cuenca & Mauricio Perdomo
      </p>
    </center>
    <center>
      <p> Universidad Sur Colombiana 2020
      </p>
    </center>
  </footer>
